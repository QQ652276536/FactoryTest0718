...
/**
 * 绘制人脸框帮助类，用于在{@link com.zistone.factorytest0718.face.widget.FaceRectView}上绘制矩形
 */
public class DrawHelper {
    ...
    public static void DrawFaceRect(Canvas canvas, DrawInfo drawInfo, int faceRectThickness, Paint paint) {
        ...
        if (drawInfo.getName() == null) {
            ...
            String str = (drawInfo.getSex() == GenderInfo.MALE ? "男性" : (drawInfo.getSex() == GenderInfo.FEMALE ? "女性" : "未知")) + "," + (drawInfo.getAge() == AgeInfo.UNKNOWN_AGE ? "未知" : drawInfo.getAge()) + "," + (drawInfo.getLiveness() == LivenessInfo.ALIVE ? "活体" : (drawInfo.getLiveness() == LivenessInfo.NOT_ALIVE ? "非活体" : "未知"));
